...
export type RequestStatus = 'Pendente' | 'Aprovado' | 'Rejeitado' | 'Em Analise' | 'Em Ajuste' | 'Parecer Juridico' | 'Orcamento' | 'Assinatura Ordenador' | 'Assinatura Gestor' | 'Autorizado';
