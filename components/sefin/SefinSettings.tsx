...
export const SefinSettings: React.FC<SefinSettingsProps> = ({ darkMode = false, userProfile }) => {
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className={`text-sm mt-1 ${darkMode ? 'text-slate-400' : 'text-slate-500'}`}>
                        Gerencie parâmetros técnicos e administrativos do módulo Financeiro.
                    </p>
                </div>
            </div>
                    ...
                    <div className={`rounded-2xl border shadow-sm min-h-[600px] p-6 ${cardClass}`}>
                        ...
                        {activeTab === 'general' && (
                            <div className="flex flex-col items-center justify-center h-96 text-center animate-in fade-in zoom-in-95">
                                ...
                                <p className="text-slate-500 max-w-sm mt-2">
                                    Configurações globais do sistema de execução financeira.
                                </p>
                            </div>
                        )}
                        ...
                        {activeTab === 'roles' && (
                            <div className="flex flex-col items-center justify-center h-96 text-center animate-in fade-in zoom-in-95">
                                ...
                                <p className="text-slate-500 max-w-sm mt-2">
                                    Gestão de atribuições e permissões de acesso SEFIN.
                                </p>
                            </div>
                        )}
                        ...
                        {activeTab === 'notifications' && (
                            <div className="flex flex-col items-center justify-center h-96 text-center animate-in fade-in zoom-in-95">
                                ...
                                <p className="text-slate-500 max-w-sm mt-2">
                                    Configuração de alertas e templates de e-mail financeiros.
                                </p>
                            </div>
                        )}
