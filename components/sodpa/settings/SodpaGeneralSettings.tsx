...
import { SodpaParameters } from './SodpaParameters';
import { ComarcasSettings } from '../../settings/ComarcasSettings';
import { UnidadesSettings } from '../../settings/UnidadesSettings';

interface SodpaGeneralSettingsProps {
    darkMode?: boolean;
}

type GeneralTab = 'parametros' | 'comarcas' | 'unidades';

export const SodpaGeneralSettings: React.FC<SodpaGeneralSettingsProps> = ({ darkMode = false }) => {
            ...
            <div className="min-h-[400px]">
                {activeTab === 'parametros' && (
                    <div className="animate-in fade-in duration-200">
                        <SodpaParameters darkMode={darkMode} />
                    </div>
                )}
